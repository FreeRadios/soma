 ...
 * 02111-1307, USA.
 *
 * $Id: hash_table.c,v 1.2 2006-10-05 07:20:28 bakunin Exp $
 *
 ********************************************************************/
...
static inline void              hk_fill(ght_hash_key_t *p_hk, int i_size, void *p_key);
static inline ght_hash_entry_t *he_create(ght_hash_table_t *p_ht, void *p_data, unsigned int i_key_size, void *p_key_data);
